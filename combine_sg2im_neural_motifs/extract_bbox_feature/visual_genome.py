...
class VG(Dataset):
    def __init__(self, mode, roidb_file=VG_SGG_FN, dict_file=VG_SGG_DICT_FN,
        ...
        :param proposal_file: If None, we don't provide proposals. Otherwise file for where we get RPN
            proposals
        :param flip: -1: random; 0: not flip; 1: flip
        """
    ...
    def splits(cls, *args, **kwargs):
        ...
        return train_not_flip, train_flip, val, test
...
class VGDataLoader(torch.utils.data.DataLoader):
    ...
    @classmethod
    def splits(cls, train_not_flip_data, train_flip_data, val_data, test_data, batch_size=3, num_workers=1, num_gpus=3, mode='det',
               **kwargs):
        assert mode in ('det', 'rel')
        ...
        return train_not_flip_load, train_flip_load, val_load, test_load
