...
generator = nn.ModuleList(
    ...
    nn.BatchNorm2d(64),
    nn.ReLU(True),
    nn.TransposeConv2d(64, 32, kernel_size=3, stride=2, padding=0),
    nn.BatchNorm2d(32),
    nn.ReLU(True),
    nn.TransposeConv2d(32, 16, kernel_size=3, stride=2, padding=0),
    nn.BatchNorm2d(16),
    nn.ReLU(True),
    nn.TransposeConv2d(16, 8, kernel_size=3, stride=2, padding=0),
    nn.BatchNorm2d(8),
    nn.ReLU(True),
    nn.TransposeConv2d(8, 3, kernel_size=3, stride=2, padding=0),
    nn.BatchNorm2d(32),
    nn.ReLU(True),
